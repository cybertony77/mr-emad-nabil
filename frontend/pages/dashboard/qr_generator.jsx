        ...
        try {
          ...
          if (element.tagName.toLowerCase() === 'canvas') {
            ...
            if (container) {
              ...
              gradient.addColorStop(0, '#59B339');
              gradient.addColorStop(1, '#089CAA');
    ...
    <div style={{ 
      ...
      <style jsx>{`
        ...
        .hidden-qr .qr-container {
          background: linear-gradient(250deg, #59B339 0%, #089CAA 100%);
          padding: 10px;
          border-radius: 20px;
          overflow: hidden;
          display: flex;
            ...
            <div className="qr-center-wrapper">
              <div className="qr-display">
                <div className="qr-container">
                  <QRCode
                    id="single-qr-svg"
                    value={`https://www.facebook.com/share/1AYPTzwH5c/?id=${singleId}`}
                    size={qrSize}
                    ecLevel="H"
                    logoImage="/logo.png"
                    logoWidth={logoSize}
          ...
          <div className="hidden-qr">
            {qrIds.map((id) => (
              <div className="qr-container" key={id}>
                <QRCode
                  id={`hidden-qr-${id}`}
                  value={`https://www.facebook.com/share/1AYPTzwH5c/?id=${id}`}
                  size={qrSize}
                  ecLevel="H"
                  logoImage="/logo.png"
                  logoWidth={logoSize}
